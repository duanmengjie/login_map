...
;!function (win, $, undefined) {
	var SVGMap = (function () {
		...
		SVGMap.prototype.options = {
			...
			mapWidth: 1020,
			mapHeight: 730,
			stateColorList: ['2770B5', '429DD4', '5AABDA', '1C8DFF', '70B3DD', 'C6E1F4', 'fff'],
			...
			stateInitColor: 'fff',
			stateHoverColor: '33afe4',
			stateSelectedColor: '33afe4',
		...
		SVGMap.prototype.render = function () {
			...
			for (var state in mapConfig.shapes) {
				...
				obj.company = mapConfig['companys'][state];
				console.log(obj.company);
				obj.attr(attributes);

				// for (var item in obj.company) {
				...
				if (stateData[state] && stateData[state].diabled) {
					...
					obj.click(function (e) {
						...
						$(".stateTip").on('click','.closebtn',function(){
                            $(".stateTip").remove();
                        });
					});
